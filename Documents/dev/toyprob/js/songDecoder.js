...
words "WUB" before the first word of the song (the number may be zero),
after the last word (the number may be zero), and between words
(at least one between any pair of neighbouring words), and then
...
function songDecoder(song){
  ...
  var ret = song.replace(/WUBWUB/gi, '#').replace(/WUB/gi, ' ').split('#');
