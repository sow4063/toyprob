...
In each frame the player rolls 1 or 2 balls, except for the 10th frame, where the player rolls 2 or 3 balls.
...
If you knock down all 10 pins with 2 balls (spare),
you score the amount of pins knocked down plus a bonus - amount of pins knocked down with the next ball
If you knock down all 10 pins with 1 ball (strike),
you score the amount of pins knocked down plus a bonus - amount of pins knocked down with the next 2 balls
...
var bowlingScore = function(rolls) {
  ...
  for( var i = 0; i < rolls.length - 3; i++ ) {
    var val = rolls[i] + rolls[i+1] + rolls[i+2];
  }
  return result;
};
