...
function minimumSum(values, n) {
  ...
  return values.slice(-n).reduce(function(a,b){return a+b;});
};

function maximumSum(values, n) {
  if( values.length == 0 || n == 0 ) return 0;
  values.sort(function(a,b){return b-a;});
  return values.slice(0, n).reduce(function(a,b){return a+b;});
};
...
// best practice
function minimumSum2(values, n) {
  return add(values.sort(sort), n);
}

function maximumSum2(values, n) {
